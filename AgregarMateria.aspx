<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AgregarMateria.aspx.cs" Inherits="ProyectoPP2024.AgregarMateria" %>
    ...
    <div class="p-4" style="width:auto;">
        <h3 class="text-center">Agregar Materia</h3>
                ...
                <div class="d-flex justify-content-center">
                    <asp:Button ID="btnAgregarMateria" runat="server" Text="Agregar" 
                        CssClass="btn btn-primary w-100" onclick="btnAgregarMateria_Click"/>
                </div>
