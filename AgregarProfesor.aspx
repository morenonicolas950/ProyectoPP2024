<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="AgregarProfesor.aspx.cs" Inherits="ProyectoPP2024.AgregarProfesor" %>
        ...
        <div class="p-4" style="width:auto;">
            ...
            <h3 class="text-center">Registrar Profesor</h3>
                ...
                <div class="d-flex justify-content-center">
                    <asp:Button ID="btnRegistrarProfesor" runat="server" Text="Registrar" CssClass="btn btn-primary w-100" OnClick="btnRegistrarProfesor_Click" />
                </div>
